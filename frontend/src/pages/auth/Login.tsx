...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-white" style={{ fontSize: '16px' }}>
      ...
      {/* ── LEFT: Form ── */}
      <div className="flex flex-col px-10 py-6 lg:px-16 col-span-6">
          ...
          <div className="flex flex-col items-center justify-center w-full flex-1">
            <form onSubmit={handleSubmit} className="w-full max-w-[575px]" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ marginBottom: 8 }}>
                <h1 className="font-bold text-gray-900 text-center" style={{ fontSize: 32 }}>Welcome back</h1>
                <p className="text-gray-500 text-center" style={{ fontSize: 16, marginTop: 4 }}>Enter your email and password to access your account</p>
              </div>
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col justify-start" style={{ marginTop: 132, marginLeft: 52, marginRight: 46 }}>
          <p className="text-gray-100 font-semibold leading-tight" style={{ fontSize: 34 }}>
            Study smarter with your AI powered revision companion
          </p>
          <p className="text-white/50" style={{ marginTop: 12 }}>
            Upload your materials, generate quizzes and assessments, get instant AI answers, and track your exam readiness — all powered by AI.
          </p>
